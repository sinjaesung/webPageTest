...
class LineParticle{
    constructor(texturesrc,x_distance,y_distance,z_distance,x_start,y_start,z_start,color,size){  
        console.log("lineParticle생성요구!!:",texturesrc,x_distance,y_distance,z_distance,x_start,y_start,z_start,color);
        this._setupModel(texturesrc,x_distance,y_distance,z_distance,x_start,y_start,z_start,color,size);
    }
    _setupModel(texturesrc,x_distance,y_distance,z_distance,x_start,y_start,z_start,color,size){
        ...
        this._AddParticles(x_distance,y_distance,z_distance,x_start,y_start,z_start,color,size);
        this._UpdateGeometry();
    }
    
    _AddParticles(x_distance,y_distance,z_distance,x_start,y_start,z_start,color,sizes=6) {
       // let x_distance=420;
        //let z_distance=670;
        //let y_distance=85;
        //let x_start=0;
           ...
           // color.setRGB(Math.random(),Math.random(),Math.random())
            ...
            this._particles.push({
                position: new THREE.Vector3(
                    ...
                    x_start + (x_distance/100*i),//0/100,1/100,2/100,.....100/100
                    y_start+ (y_distance/100*i),
                    z_start+ (z_distance/100*i)
                ),
            ...
            //  maxLife: life,
                ...
                //velocity: new THREE.Vector3(updafteparams.velocityX,updateparams.velocityY,updateparams.velocityZ),//updateparams.velocityX,updateparams.velocityY,updateparams.velocityZ,
            });
        }
    }
    _UpdateGeometry() {
