...
class App {
                    ...
                    if(this.NextEntrance){
                        window.setTimeout(()=>{
                           ...
                           // let mapMoveForm=document.getElementById("mapMoveForm");
                            ...
                            for(let s in moveForm_parameters){
                                ...
                                if(s==='loadposx'){
                                   // var key=CryptoJS.enc.Utf8.parse('-333');//원본밸류의 key값만듬.
                                    ...
                                    moveForm_parameters['loadposy']='-143';
                                    ...
                                    moveForm_parameters['loadposz']='-875';
                            ...
                            location.href='AmmoRigidBaseMetaWorldControlTower.html';
                        },200);
                    }
                            ...
                            for(let s in moveForm_parameters){
                                ...
                                if(s==='loadposx'){
                                   // var key=CryptoJS.enc.Utf8.parse('-333');//원본밸류의 key값만듬.
                                    ...
                                    moveForm_parameters['loadposx']='-1250';
                                }else if(s==='loadposy'){
                                    moveForm_parameters['loadposy']='-978';
                                    //var key=CryptoJS.enc.Utf8.parse('7');//원본밸류의 key값만듬.
                                    //console.log("각문자열에 대한 경우의수별 랜덤한 key값!:",key);
                                    //var base64=CryptoJS.enc.Base64.stringify(key);
                                    //parameter.value=base64;
                                    ...
                                    moveForm_parameters['loadposz']='-853';
                                      //var key=CryptoJS.enc.Utf8.parse('2220');//원본밸류의 key값만듬.
                                      //console.log("각문자열에 대한 경우의수별 랜덤한 key값!:",key);
                                      //var base64=CryptoJS.enc.Base64.stringify(key);
                                      //parameter.value=base64;
    ...
    createAmmo(Ammo=this.ammoClone,){
        ...
        this.createGLTFGroup('https://sinjaesung.github.io/3DASSET/terrain/evil/industryMap.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,{//convexhull로해야만함!!!
            'shapeType':'convexTriangle'
        }); 
         //포탈!!(맵간 이동) 별도 파라미터 넣지않으면 이동시 맵의 초기설정위치에서 로드,pos넣을시 그 post에 관련된 위치에서 카메라랑,캐릭터랑 해서 로드
         this.NextPORTAL('https://sinjaesung.github.io/3DASSET/terrain/evil/industryMap_Nextfortal.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,{
            'shapeType':'convexTriangle'
        });
        
        this.StartPORTAL('https://sinjaesung.github.io/3DASSET/terrain/evil/industryMap_Startfortal.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,{
            'shapeType':'convexTriangle'
        });  
        // 몬스터
        ...
        added_loadmodel_bg['src']="https://sinjaesung.github.io/3DASSET/machine_shop_03_4k.hdr";
        added_loadmodel_bg['isloaded']=false;
        this.loadmodels.push(added_loadmodel_bg);

        new RGBELoader().load("https://sinjaesung.github.io/3DASSET/machine_shop_03_4k.hdr",(texture)=>{
