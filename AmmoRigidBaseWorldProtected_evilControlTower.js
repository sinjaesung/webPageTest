...
class App {
                ...
                if(this.character1.userData.hp <= 0){
                    ...
                    if(this.StartEntrance){
                        window.setTimeout(()=>{
                            ...
                            for(let s in moveForm_parameters){
                                ...
                                if(s==='loadposx'){
                                   // var key=CryptoJS.enc.Utf8.parse('-333');//원본밸류의 key값만듬.
                                    ...
                                    moveForm_parameters['loadposx']='581';
                                }else if(s==='loadposy'){
                                    ...
                                    moveForm_parameters['loadposz']='-102';
                            ...
                            location.href='AmmoRigidBaseMetaWorldevilcore.html';
                        },200);
                    } 
                    //맵별로 다르게 할부분 endsss`
                }
    ...
    createAmmo(Ammo=this.ammoClone,){
        ...
        this.createGLTFGroup('https://sinjaesung.github.io/3DASSET/terrain/evil/evilControlTower.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,{
            'shapeType':'convexTriangle'
        });
      
        //포탈!!(맵간 이동) 별도 파라미터 넣지않으면 이동시 맵의 초기설정위치에서 로드,pos넣을시 그 post에 관련된 위치에서 카메라랑,캐릭터랑 해서 로드
        this.StartPORTAL('https://sinjaesung.github.io/3DASSET/terrain/evil/evilControlTower_Startfortal.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,{
            'shapeType':'convexTriangle'
        });  
         //애너미 빌딩passive형태
        let buildlingColor=new THREE.Color();
        buildlingColor.setRGB(0.1,0.2,0.3); 
        ...
        this.createGLTF_EnemyBuildinggroup('https://sinjaesung.github.io/3DASSET/terrain/evil/evilControlTower_destroyBuildinggroup1.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,24000,125,buildlingColor,collapseSounds)
        
        buildlingColor=new THREE.Color();
        buildlingColor.setRGB(0.7,0.6,0.2); 
        ...
        this.createGLTF_EnemyBuildinggroup('https://sinjaesung.github.io/3DASSET/terrain/evil/evilControlTower_destroyBuildinggroup2-1.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,32000,160,buildlingColor,collapseSounds)
  
  
        buildlingColor=new THREE.Color();
        buildlingColor.setRGB(0.9,0.2,0.1); 
        ...
        this.createGLTF_EnemyBuildinggroup('https://sinjaesung.github.io/3DASSET/terrain/evil/evilControlTower_destroyBuildinggroup2-2.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,40000,260,buildlingColor,collapseSounds)
        ...
        this.createGLTF_EnemyBuildinggroup('https://sinjaesung.github.io/3DASSET/terrain/evil/evilControlTower_destroyBuildinggroup3.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,12000,80,buildlingColor,collapseSounds)
  
  
        buildlingColor=new THREE.Color();
        buildlingColor.setRGB(0.8,0.9,0.1); 
        ...
        this.createGLTF_EnemyBuildinggroup('https://sinjaesung.github.io/3DASSET/terrain/evil/evilControlTower_destroyBuildingCenterking.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,30000,180,buildlingColor,collapseSounds)
  
        buildlingColor=new THREE.Color();
        buildlingColor.setRGB(0.99,0.4,0.08); 
        ...
        this.createGLTF_EnemyBuildinggroup('https://sinjaesung.github.io/3DASSET/terrain/evil/evilControlTower_destroyBuildingEvilking.glb',Ammo,null,{x:0,y:0,z:0,w:1},0,100000,400,buildlingColor,collapseSounds)
  
        // 몬스터
         for(let e=0; e<1; e++){//humanBad created Types (메카닉:전투기계들,바이오닉,사이보그) 인간계최종보스(god등급)
            let unit=e%2==0?-1:1;
            let x=3
            let y=Math.random()*3+150;//항상양수
            let z=-485;
            ...
            let attackParticlesrc='https://sinjaesung.github.io/3DASSET/mob/evilGodExplosion.jpg';
            let attackColor=new THREE.Color();
            let steps=24;
            attackColor.setRGB(1,0.26,0); 
          ...
          audioLoader_local2.load('https://sinjaesung.github.io/3DASSET/mob/mahcine_explodeSound.mp3',function(buffer){
            ...
            this.createEnemyGLTF3(Ammo,pos,"https://sinjaesung.github.io/3DASSET/mob/EvilGod.glb",null,e,hp,power,'God',speed,mass,'evilGod','https://sinjaesung.github.io/3DASSET/mob/evilGod_ballchild.glb',skillPos,null,defense,distanceamount,isAir,attackRangeAmount,attackParticlesrc,attackSounds,attackColor,isAirChase,steps,1,diedSound);
        } 
        for(let e=0; e<2; e++){//humanBad created Types (메카닉:전투기계들,바이오닉,사이보그) 메카닉king
            ...
            let mass=200;
            let defense=500;
            let distanceamount=250;
            let airAmountflag=1.3;
            let isAir=true;
            let isAirChase=true;
  
            let attackRangeAmount=22;
            let attackParticlesrc='https://sinjaesung.github.io/3DASSET/mob/fighterPlaneExplosion.jpg';
            let attackColor=new THREE.Color();
            let steps=24;
            ...
            for(let a=0; a<2; a++){
                ...
                let attackSound=new THREE.Audio(audioListener_individual);
                let audioLoader_local=new THREE.AudioLoader();
                audioLoader_local.load('https://sinjaesung.github.io/3DASSET/mob/planeBigExplosion.mp3',function(buffer){//무기공격성공시사운드 다르게
                    attackSound.setBuffer(buffer);
                    attackSound.setLoop(false);
                    attackSound.setVolume(0.3);
                });
            ...
            this.createEnemyGLTF3(Ammo,pos,"https://sinjaesung.github.io/3DASSET/mob/AirPlane1.glb",null,e,hp,power,'King',speed,mass,'AirPlane','https://sinjaesung.github.io/3DASSET/mob/AirPlane1_ballchild.glb',skillPos,null,defense,distanceamount,isAir,attackRangeAmount,attackParticlesrc,attackSounds,attackColor,isAirChase,steps,airAmountflag,diedSound);
        } 
        for(let e=0; e<2; e++){//humanBad created Types (메카닉:전투기계들,바이오닉,사이보그) 메카닉king
            let unit=e%2==0?-1:1;
            let x=Math.random()*80*unit; //-500~500범위가능
            ...
            let attackRangeAmount=20;
            let attackParticlesrc='https://sinjaesung.github.io/3DASSET/mob/HelliCopterKingExplodes.jpg';
            let attackColor=new THREE.Color();
            let steps=24;
            attackColor.setRGB(1,0.46,0); 
            ...
            for(let a=0; a<6; a++){
                ...
                let attackSound=new THREE.Audio(audioListener_individual);
                let audioLoader_local=new THREE.AudioLoader();
                audioLoader_local.load('https://sinjaesung.github.io/3DASSET/mob/explosionHelli_.mp3',function(buffer){//무기공격성공시사운드 다르게
                    attackSound.setBuffer(buffer);
                    attackSound.setLoop(false);
                    attackSound.setVolume(0.3);
                });
        ...
        for(let e=0; e<12; e++){//humanBad created Types (메카닉:전투기계들,바이오닉,사이보그) 상급boss
            let unit=e%2==0?-1:1;
            let x=Math.random()*80*unit; //-500~500범위가능
            let y=Math.random()*3+70;//항상양수
            let z=Math.random()*80*unit
            ...
            let mass=1000;
            let defense=1000;
            let distanceamount=400;
            let isAir=false;
            let isAirChase=true;
  
            let attackRangeAmount=12;
            let attackParticlesrc='https://sinjaesung.github.io/3DASSET/mob/TankBossExplosion.jpg';
            let attackColor=new THREE.Color();
            let steps=12;
            ...
            for(let a=0; a<1; a++){
                ...
                let attackSound=new THREE.Audio(audioListener_individual);
                let audioLoader_local=new THREE.AudioLoader();
                audioLoader_local.load('https://sinjaesung.github.io/3DASSET/mob/tankexplosion.mp3',function(buffer){//무기공격성공시사운드 다르게
                    attackSound.setBuffer(buffer);
                    attackSound.setLoop(false);
                    attackSound.setVolume(0.3);
                });
