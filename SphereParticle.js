...
class SphereParticle{
    //무기형은 x좌표로 길게 늘어진거 사용
    constructor(texturesrc,xamountshape,yamountshape,zamountshape,x_origin,y_origin,z_origin,color,xTanFlag,ySinFlag,zCosFlag,particleSize,step){  
        console.log("SphereParticle생성요구!!:",texturesrc,xamountshape,yamountshape,zamountshape,x_origin,y_origin,z_origin,color,xTanFlag,ySinFlag,zCosFlag,particleSize,step);
        this._setupModel(texturesrc,xamountshape,yamountshape,zamountshape,x_origin,y_origin,z_origin,color,xTanFlag,ySinFlag,zCosFlag,particleSize,step);
    }
    _setupModel(texturesrc,xamountshape=40,yamountshape=10,zamountshape=20,x_origin,y_origin,z_origin,color,xTanFlag,ySinFlag,zCosFlag,particleSize,step){
        ...
        this._AddParticles(xamountshape,yamountshape,zamountshape,x_origin,y_origin,z_origin,color,xTanFlag,ySinFlag,zCosFlag,particleSize,step);
        this._UpdateGeometry();
    }
    
    _AddParticles(xamountshape,yamountshape,zamountshape,x_origin,y_origin,z_origin,color,xTanFlag,ySinFlag,zCosFlag,particleSize,step) {
       // let x_distance=420;
        //let z_distance=670;
        //let y_distance=85;
        //let x_start=0;
           ...
           // color.setRGB(Math.random(),Math.random(),Math.random())
            ...
            this._particles.push({
                position: new THREE.Vector3(
                    ...
                    x_origin + (xamountshape*Math.tan(xTanFlag*i)),//-40~40 40*-1~1
                    y_origin + (yamountshape*Math.sin(ySinFlag*i)),//-10~10
